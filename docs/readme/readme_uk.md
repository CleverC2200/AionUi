...
[🤔 Чому варто обрати GEAUi?](#-чому-варто-обрати-aionui-замість-claude-cowork) ·
...
- **Єдине керування MCP** — керуйте MCP-інструментами в одному місці; GEAUi додає або синхронізує сумісні транспорти відповідно до можливостей кожного агента
...
- **Паралельне виконання кількох агентів** — Leader ділить і делегує завдання Teammate-агентам; зовнішні агенти підключаються через ACP (Agent Client Protocol), а GEAUi координує команду
...
- **🧭 GEAUi Butler** — Поради щодо продукту, допомога з налаштуванням і усунення несправностей в GEAUi
...
> 💡 Канонічні вбудовані визначення містяться в [каталозі асистентів](https://github.com/iOfficeAI/AionCore/blob/main/crates/aionui-app/assets/builtin-assistants/assistants.json) GEACore. Правила залишаються у Markdown і налаштовуються в GEAUi.
