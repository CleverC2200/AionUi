          ...
          <div className='group/label sider-section-label flex items-center px-12px h-28px select-none sticky top-0 z-10 mt-8px'>
            ...
            <Tooltip content={t('team.sider.createTeam')} position='top'>
              <div
                ...
                className='ms-auto -me-4px size-20px rd-4px border border-solid border-transparent flex items-center justify-center hover:bg-fill-4 focus-visible:border-primary-6 focus-visible:bg-fill-4 focus-visible:outline-none transition-all shrink-0 cursor-pointer text-t-secondary hover:text-t-primary'
                onClick={(event) => {
