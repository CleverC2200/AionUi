              ...
              <div className='flex flex-col gap-9px'>
                {selectedAssistantPrompts.map((prompt, index) => (
                  <Button
                    key={`${index}-${prompt}`}
                    type='text'
                    className='group self-start !h-auto !w-fit !max-w-full !border-none !bg-transparent !px-0 !py-6px !text-start !text-12.5px !text-t-secondary !whitespace-normal !break-words transition-colors hover:!bg-transparent hover:!text-t-primary'
                    onClick={() => {
